...
#Forming commands
BlockStorage_Auth_Command="curl -H \"Content-Type:application/json\" --data @../Json/BlockStorage_Auth.json https://$userid:$apikey@api.softlayer.com/rest/v3/SoftLayer_Network_Storage_Iscsi/17944117/allowAccessFromVirtualGuest"
