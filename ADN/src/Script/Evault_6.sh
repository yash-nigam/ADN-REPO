...
#Forming commands
Evault_Command="curl -H \"Content-Type:application/json\" --data @../Json/Evault_VirtualGuest.json https://$userid:$apikey@api.softlayer.com/rest/v3/SoftLayer_Product_Order/placeOrder"
