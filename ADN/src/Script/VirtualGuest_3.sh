...
#Forming commands
VirtualGuest_Command="curl -H \"Content-Type:application/json\" --data @../Json/Vm-web.json https://$userid:$apikey@api.softlayer.com/rest/v3/SoftLayer_Virtual_Guest/createObject"
